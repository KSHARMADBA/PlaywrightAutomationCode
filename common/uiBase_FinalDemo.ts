...
test('Validate Hub Registration', async ({ page, baseURL }) => {
    const url = baseURL + resource
    await testSpec.validateHomePage({ page, url })
    // await testSpec.loginPage(page, url ) 
    // await testSpec.loginPage({ page, url }) 
    ...
    const hub_name = 'chennaiHub3' // Replace "hub_name" with the required value
    await testSpec.hubRegistration(page, hub_name)
    // await testSpec.logOut({page,url})
}
)

test.only(" Validate the behavior when Hub Name is Blank", async ({ page, baseURL }) => {
    const url = baseURL + resource
    await testSpec.validateHomePage({ page, url })
    // await testSpec.loginPage({ page, url })
    const userlogin = 'austin@dbyarforum.org'; // Replace 'yourUsername' with the actual username
...
test(" Validate the behavior when hub name conatins leading & trailing space", async ({ page, baseURL }) => {
    const url = baseURL + resource
    await testSpec.validateHomePage({ page, url })
    // await testSpec.loginPage({ page, url })
    const userlogin = 'austin@dbyarforum.org'; // Replace 'yourUsername' with the actual username
...
test(" Validate the behavior when hub name exceeds maximum defined length", async ({ page, baseURL }) => {
    const url = baseURL + resource
    await testSpec.validateHomePage({ page, url })
    // await testSpec.loginPage({ page, url })
    const userlogin = 'austin@dbyarforum.org'; // Replace 'yourUsername' with the actual username
...
test('Validate a success Hub Registration after negative scenarios', async ({ page, baseURL }) => {
    ...
    await testSpec.loginPage(page, userlogin)
    // await testSpec.loginPage({ page, url })  
    const hub_name = 'retest73' // Replace "hub_name" with the required value
    await testSpec.hubRegistration(page, hub_name)
...
// Negative test case: when Person-Incharge is blank
